   ...
   <section className="bg-[#D1E3FF] min-h-screen ">
     ...
     <div className="container mx-auto flex flex-col-reverse md:flex-row items-center gap-12 "> 
       <div className="flex-1 text-center md:text-left pt-40 relative "> 
         ...
         <div className="flex justify-center md:justify-start gap-4 "> <button className="homeb bg-[#FF8A1D] text-white px-6 py-2 rounded hover:bg-amber-500 transition"> CONTACT US </button> </div> </div> {/* Image */} <div className="home-image flex-1 "> <img src="home.png" alt="Repair Service" className="homeimg relative left-0 md:left-20 lg:left-40 bottom-0 md:bottom-5 lg:bottom-10 w-52 sm:w-64 md:w-100 lg:w-[800px] h-auto float-img" /> </div> </div>
  {/*=========== Service Card============= */}
